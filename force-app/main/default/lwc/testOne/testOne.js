...
//     URL = "https://services9.arcgis.com/N9p5hsImWXAccRNI/arcgis/rest/services/Z7biAeD8PAkqgmWhxG2A/FeatureServer/1/query?f=json&where=Confirmed%20%3E%200&outFields=Country_Region,Confirmed,Deaths,Recovered,Last_Update,Active&orderByFields=Confirmed%20desc"
// initialValue = {
//     total_deaths: 0,
//     total_confirmed: 0,
//     total_active: 0,
...
// }
// status = ["Confirmed", "Active", "Deaths", "Recovered"]
// colors = { "Confirmed": '#007bff', "Active": "#dd9105", "Recovered": "#28a745", "Deaths": "#dc3545" }

//     @track tableData = []
//     @track filteredtableData = []
//     @track total = this.initialValue
//     @track countryList = []
...
//         })
//         this.graphData = this.status.map(item => {
//             return { name: item, color: this.colors[item], y: country[0][item] }
//         })
